...
\vspace{0.15in}
\begin{center}
\includegraphics[width=1.0\textwidth,height=9.2cm,keepaspectratio=true]{images/block-diagram.png}
...
\vspace{0.15in}
\begin{center}
\includegraphics[width=0.95\textwidth,height=7.8cm,keepaspectratio=true]{images/l298n_motordriver_pinout_bb.png}
