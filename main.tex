...
\vspace{0.1in}
\begin{center}
\includegraphics[width=0.85\textwidth,height=6.0cm,keepaspectratio=true]{images/block-diagram.png}
...
\vspace{0.1in}
\begin{center}
\includegraphics[width=0.85\textwidth,height=6.2cm,keepaspectratio=true]{images/l298n_motordriver_pinout_bb.png}
...
\section{Conclusions}
This mini project successfully demonstrates the design, physical construction, calibration, and performance evaluation of an ESP32-based gesture-controlled 4-wheel drive robotic car. By interfacing the MPU6050 6-axis inertial measurement unit with Espressif's high-speed, connectionless ESP-NOW protocol, the wearable glove controller successfully translates wrist tilt gestures (Pitch and Roll orientation angles) into precise physical movement vectors. The dual L298N H-bridge motor driver configurations regulate the speed and direction of four 200 RPM dual shaft BO motors independently, achieving a low signal latency of 8 ms and a reliable wireless range of 45 meters under active line-of-sight test conditions. A split power system utilizing dual 18650 cells keeps the motor drivers and microcontrollers isolated from voltage spikes, ensuring system stability.\par
\medskip
In summary, gesture-based control provides a natural and intuitive human-machine interface that is highly accessible and eliminates the need for manual dexterity required by traditional joysticks or mobile applications. The holonomic motion model, implemented using the Mecanum wheel steering matrix, enables the vehicle to move laterally, diagonally, and perform spot rotations seamlessly. The prototype successfully balances range, processing speed, and power efficiency, establishing a solid baseline for warehouse logistics, search-and-rescue assistance, and gesture-controlled assistive mobility platforms.
