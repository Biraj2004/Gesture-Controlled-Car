...
\vspace{0.15in}
\begin{center}
\makebox[\textwidth][c]{\includegraphics[width=1.1\textwidth,height=10.2cm,keepaspectratio=true]{images/block-diagram.png}}
...
\vspace{0.15in}
\begin{center}
\makebox[\textwidth][c]{\includegraphics[width=1.05\textwidth,height=9.2cm,keepaspectratio=true]{images/l298n_motordriver_pinout_bb.png}}
...
\vspace{0.15in}
\begin{center}
\includegraphics[width=0.75\textwidth,height=8.5cm,keepaspectratio=true]{images/final_transmitter.png}
\captionof{figure}{Final Transmitter Assembly}
\label{fig:final_transmitter}
\end{center}
\vspace{0.15in}
\begin{center}
\includegraphics[width=0.75\textwidth,height=8.5cm,keepaspectratio=true]{images/final_receiver_on_car.png}
\captionof{figure}{Final Receiver Mounted on Car}
\label{fig:final_receiver}
\end{center}

\section{Performance Evaluation}
The prototype was evaluated on latency, range, and battery life. The ESP-NOW system achieved a latency of 8 ms and a reliable range of 45 m. A 2200 mAh 18650 battery pack provides 45 minutes of continuous operation. Figures \ref{fig:wiring}, \ref{fig:test}, and \ref{fig:battery} show the 4WD car and two views of the transmitter setup.\par
\vspace{0.1in}
\begin{center}
\begin{minipage}{0.31\textwidth}
  \centering
  \includegraphics[width=\textwidth,height=5.5cm,keepaspectratio=true]{images/img3.jpeg}
  \captionof{figure}{4WD Car}
  \label{fig:wiring}
\end{minipage}
\hfill
\begin{minipage}{0.31\textwidth}
  ...
  \captionof{figure}{Transmitter View 1}
  \label{fig:test}
\end{minipage}
\hfill
\begin{minipage}{0.31\textwidth}
  ...
  \captionof{figure}{Transmitter View 2}
  \label{fig:battery}
\end{minipage}
\end{center}
